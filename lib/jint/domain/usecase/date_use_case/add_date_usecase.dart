...
class AddDateUseCase extends BaseUseCase<Date, DateParameters> {
  final BaseDateRepository baseDateRepository;

  AddDateUseCase({required this.baseDateRepository});

  @override
  Future<Either<Failure, Date>> call(DateParameters parameters) async {
    return await baseDateRepository.addDate(parameters);
  }
