...
class DeleteSpecialtyUseCase extends BaseUseCase<Specialty,SpecialtyParameters>{
  final BaseSpecialtyRepository baseSpecialtyRepository;

  DeleteSpecialtyUseCase({required this.baseSpecialtyRepository});

  @override
  Future<Either<Failure, Specialty>> call(SpecialtyParameters parameters)async {
    return await baseSpecialtyRepository.deleteSpecialty(parameters);
  }
}
