...
class AddDateDetailsUseCase extends BaseUseCase<DateDetails,DateDetailsParameters>{
  final BaseDateDetailsRepository baseDateDetailsRepository;

  AddDateDetailsUseCase({required this.baseDateDetailsRepository});

  @override
  Future<Either<Failure, DateDetails>> call(DateDetailsParameters parameters)async {
    return await baseDateDetailsRepository.addDateDetails(parameters);
