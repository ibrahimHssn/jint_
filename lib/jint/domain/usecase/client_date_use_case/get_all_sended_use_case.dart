...
class GetAllSendedUseCase extends BaseUseCase<List<ClientDate>,ClientDateParameters>{
  final  BaseClientDateRepository baseClientDateRepository;

  GetAllSendedUseCase({required this.baseClientDateRepository});

  @override
  Future<Either<Failure, List<ClientDate>>> call(ClientDateParameters parameters) async{
      return await baseClientDateRepository.getAllSended(parameters);
