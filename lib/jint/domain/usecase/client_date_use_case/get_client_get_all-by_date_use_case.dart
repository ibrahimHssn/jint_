...
class GetClientGetAllByDateUseCase extends BaseUseCase<List<ClientDate>,ClientDateParameters>{
  final  BaseClientDateRepository baseClientDateRepository;

  GetClientGetAllByDateUseCase({required this.baseClientDateRepository});

  @override
  Future<Either<Failure, List<ClientDate>>> call(ClientDateParameters parameters) async{
      return await baseClientDateRepository.getClientGetAllByDate(parameters);
