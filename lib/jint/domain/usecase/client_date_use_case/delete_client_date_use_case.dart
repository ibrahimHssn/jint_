...
class DeleteClientDateUseCase extends BaseUseCase<ClientDate,ClientDateParameters>{
  final  BaseClientDateRepository baseClientDateRepository;

  DeleteClientDateUseCase({required this.baseClientDateRepository});

  @override
  Future<Either<Failure, ClientDate>> call(ClientDateParameters parameters) async{
      return await baseClientDateRepository.deleteClientDate(parameters);
