...
class ReActionClientDateUseCase extends BaseUseCase<ClientDate,ClientDateParameters>{
  final  BaseClientDateRepository baseClientDateRepository;

  ReActionClientDateUseCase({required this.baseClientDateRepository});

  @override
  Future<Either<Failure, ClientDate>> call(ClientDateParameters parameters) async{
      return await baseClientDateRepository.reActionClientDate(parameters);
