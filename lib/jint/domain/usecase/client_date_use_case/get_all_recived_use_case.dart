...
class GetAllRecivedUseCase extends BaseUseCase<List<ClientDate>,ClientDateParameters>{
  final  BaseClientDateRepository baseClientDateRepository;

  GetAllRecivedUseCase({required this.baseClientDateRepository});

  @override
  Future<Either<Failure, List<ClientDate>>> call(ClientDateParameters parameters) async{
      return await baseClientDateRepository.getAllRecived(parameters);
