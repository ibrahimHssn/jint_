...
class UpdateClientDateUseCase extends BaseUseCase<ClientDate,ClientDateParameters>{
  final  BaseClientDateRepository baseClientDateRepository;

  UpdateClientDateUseCase({required this.baseClientDateRepository});

  @override
  Future<Either<Failure, ClientDate>> call(ClientDateParameters parameters) async{
      return await baseClientDateRepository.updateClientDate(parameters);
